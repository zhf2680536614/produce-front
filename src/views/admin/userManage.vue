            ...
            <el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
                ...
                <el-table-column prop="gender" label="性别" width="100">
                    <template slot-scope="scope">
                        <span v-if="scope.row.gender === 1" style="color: blue;">&#9794; </span>
                        <span v-if="scope.row.gender === 2" style="color: red;"> &#9792;</span>
                ...
                <el-table-column prop="type" label="账号权限" width="140">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.type === 2" style="color: rgb(255, 100, 100);">管理员</span>
                    </template>
                </el-table-column>
